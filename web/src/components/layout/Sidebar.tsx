    ...
    <aside className="w-56 shrink-0 flex flex-col bg-sidebar border-r border-sidebar-border">
      ...
      <div className="h-11 flex items-center px-5 border-b border-sidebar-border shrink-0">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-sm font-semibold text-white tracking-tight">MArKE-IT</span>
        </div>
      </div>

      {/* Nav */}
      <nav className="flex flex-col gap-0.5 p-3 flex-1">
        <p className="text-xs font-medium uppercase tracking-widest text-sidebar-foreground/50 px-3 pt-1 pb-2">
          メニュー
        </p>
